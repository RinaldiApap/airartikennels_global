...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('adm_ext_data_artikel') }}">
    ...
    <script src="{{ asset('assets/adm/vendor/jquery/jquery.min.js') }}"></script>
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('assets/adm/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('assets/adm/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('assets/adm/js/demo/chart-pie-demo.js') }}"></script>
